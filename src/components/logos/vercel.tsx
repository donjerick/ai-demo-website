export default function VercelLogo(props: React.ComponentPropsWithoutRef<'div'>) {
  return (
    <div
      aria-label="Vercel"
      className="flex flex-row items-center justify-start fill-white"
      {...props}
    >
      <svg
        className="mr-1.5 h-7 w-7 md:h-8 md:w-8"
        fill="currentColor"
        fillRule="evenodd"
        viewBox="0 0 24 24"
        xmlns="http://www.w3.org/2000/svg"
      >
        <path d="M12 0l12 20.785H0L12 0z"></path>
      </svg>
      <svg
